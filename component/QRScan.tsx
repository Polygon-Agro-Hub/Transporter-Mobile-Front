...
const QRScan: React.FC<QRScanProps> = ({ navigation }) => {
  ...
  const [showSuccessfulReturnModal, setShowSuccessfulReturnModal] = useState(false);
  ...
  if (hasPermission === null) {
    return (
      <SafeAreaView className="flex-1 bg-gray-900 justify-center items-center">
        ...
        <Text className="text-white text-lg mt-4">Requesting camera permission...</Text>
      </SafeAreaView>
    );
  }
  ...
  if (hasPermission === false) {
    return (
      <SafeAreaView className="flex-1 bg-gray-900 justify-center items-center px-6">
        ...
        >
          <Text className="text-black font-bold text-base">Grant Permission</Text>
        </TouchableOpacity>
      </SafeAreaView>
    );
  }
        ...
        <View className="flex-1">
          ...
          <View className="flex-1 bg-black/50">
            ...
            <TouchableOpacity
              ...
              className="absolute top-5 left-4 z-10 bg-white/90 p-2.5 rounded-full"
            >
